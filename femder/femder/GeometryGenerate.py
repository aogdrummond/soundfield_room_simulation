...
class GeometryGenerator:
    ...
    def generate_symmetric_polygon(self, pts, height):
        ...
        """"""
        # SALVING THE POINTS USED FOR GENERATING THE GEOMETRY
        generation_pts = pts.copy()
        sym_gen_pts = generation_pts.copy()
    ...
    def generate_assymmetric_polygon(self, pts, height):
        ...
        gmsh.model.occ.addLine(tag, 200, tag2 + len(pts))
        tagg.append(tag2)
